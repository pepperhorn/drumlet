    ...
    <>
      ...
      <div className="share-modal fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-50 bg-card rounded-2xl shadow-2xl border border-border w-[480px] max-w-[90vw] p-6">
        ...
        <div className="flex items-center justify-between mb-5">
          <h3 className="text-lg lg:text-xl font-display font-bold text-text">Share</h3>
          <button
            className="w-8 h-8 rounded-lg bg-gray-100 hover:bg-gray-200 flex items-center justify-center text-muted hover:text-text cursor-pointer transition-colors"
            onClick={onClose}
          >
        ...
        <div className="share-section mb-4">
          <label className="text-[10px] lg:text-xs text-muted font-semibold uppercase tracking-wide block mb-1.5">
            Share Link
          </label>
          ...
          <p className="text-[9px] lg:text-[10px] text-muted mt-1">
